...
This is a tutorial explainig the basic usage of the the scripts to obthain the result of the *"Modeling in Mexican Cities using  Aerosol Optical Depth and Meteorological Reanalysis Data"* article 
...
The file that work for an entire year is `year_prediction_day_just_script.R` and the call is as follow:
...
After all predictions are made the name of bands has to be added, this step could be avoided if thi fix to set the name directly in R. 
