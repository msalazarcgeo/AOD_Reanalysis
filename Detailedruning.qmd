...
A bash script is us to move all the files 
...
9. Se hace con el script `Python_scripts/rename_single_string.py` and the bash for multiple years is the following :
```bash 
...
```bash
 python glue_bands_folder_all.py  --day_season_spline_path "../data/raster/ZMVM_seasons_days/" --day_predictions  "../data/raster/ZMVM_predictions/" --save_path_glue "../datos/raster/ZMVM_prediction_glue/" --start_year "2022" --end_year "2022"
```
...
```bash
python glue_bands_folder_all.py  --day_season_spline_path "../data/raster/ZMVM_seasons_days/" --day_predictions  "../data/raster/ZMVM_predictions/" --save_path_glue "../data/raster/ZMVM_prediction_glue/" --start_year "2022" --end_year "2022"
```

```bash
 python glue_bands_folder_all_M3.py  --day_season_spline_path "../data/raster/ZMVM_All/model_3_predict/" --day_predictions  "../data/raster/ZMVM_All/ZMVM_predictions/" --save_path_glue "../data/raster/ZMVM_All/model_3_glue/" --start_year "2004" --end_year "2022"
 ```

11. The bands has to be mearch into a single one using the script `merge_PM_25_bands`
