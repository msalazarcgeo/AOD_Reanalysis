...
get_all_seasons_interval(
    "./datos/raster//all_predictions_symlinks_ZMVT/",
    "./datos/raster/ZMVT/Season_tensor_9PBLH_ZMVT/",
    paste0(2011,"-01-01"),
    paste0(2012,"-01-31"),
    complete_band = "temperature_2m",
    splin_band = "PM25_predict"
...
```{r}
#| purl: false
list_dirs_est <- list.dirs("../data//raster/all")[-1]
...
```{r}
#| purl: false
knitr::purl("./spline_year_predictions_model3_example.qmd")
```
